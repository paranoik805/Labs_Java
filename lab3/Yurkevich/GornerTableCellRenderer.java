...
public class GornerTableCellRenderer implements TableCellRenderer //отвечает за то как отображаются наши ящейки
{
    private JPanel panel = new JPanel();//применяется к фону
    ...
    public Component getTableCellRendererComponent(JTable table,  Object value, boolean isSelected, boolean hasFocus, int row, int col)// расматривает ящейку как отдельный компонент
    {
